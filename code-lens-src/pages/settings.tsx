...
export default function SettingsPage() {
  ...
  return (
    <AppLayout>
      <div className="flex-1 overflow-auto p-4 sm:p-8" style={{ background: "#141414" }}>
        <div className="max-w-2xl mx-auto">
          {/* Header */}
          <div className="flex items-center gap-4 mb-8">
            <div className="w-1 h-10 rounded-full shrink-0" style={{ background: "#E50914" }} />
            <div className="w-10 h-10 rounded-lg flex items-center justify-center shrink-0" style={{ background: "rgba(229,9,20,0.12)" }}>
              <Settings2 className="w-5 h-5" style={{ color: "#E50914" }} />
            </div>
            <div>
              <h1 className="text-xl sm:text-2xl font-black tracking-widest uppercase" style={{ color: "#e5e5e5", letterSpacing: "0.15em" }}>
                Configurações
              </h1>
